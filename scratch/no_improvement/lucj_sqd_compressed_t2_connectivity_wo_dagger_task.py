...
class LUCJSQDCompressedT2ConnectivityWoDaggerTask:
...
def run_lucj_sqd_compressed_t2_connectivity_wo_dagger_task(
    task: LUCJSQDCompressedT2ConnectivityWoDaggerTask,
    *,
    data_dir: Path,
