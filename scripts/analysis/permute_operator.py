...
def generate_operator_permutation(diag_coulomb_mats, orbital_rotations):
    ...
    for idx, diag_coulomb_mat, orbital_rotation in zip(
        ascending_norm, diag_coulomb_mats, orbital_rotations
    ):
...
for d in bond_distance_range:
    for connectivity in connectivities:
        for n_reps in n_reps_range:
            ...
            asc_data_filename = (
                DATA_DIR / task_compressed_t2.dirpath / "asc_data.pickle"
            )
            des_data_filename = (
                DATA_DIR / task_compressed_t2.dirpath / "des_data.pickle"
            )
            rand_data_filename = (
                DATA_DIR / task_compressed_t2.dirpath / "rand_data.pickle"
            )
            ...
            operators = generate_operator_permutation(
                diag_coulomb_mats_compressed_t2, orbital_rotations_compressed_t2
            )
