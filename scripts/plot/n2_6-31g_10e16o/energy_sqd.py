...
from lucj.tasks.lucj_sqd_task import LUCJSQDTask
...
data = {}
for task in tasks:
    filepath = DATA_ROOT / "lucj_sqd" / task.dirpath / "data.pickle"
...
fig, (ax0, ax1) = plt.subplots(2, 1, figsize=(9, 9), layout="constrained")
...
tasks = [
    LUCJSQDTask(
        ...
        params="random",
        params_seed=149331520031158709917174116125181872889,
        shots=shots,
        samples_per_batch=samples_per_batch,
        n_batches=n_batches,
        max_davidson=max_davidson,
