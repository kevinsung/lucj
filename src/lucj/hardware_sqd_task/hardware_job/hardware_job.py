...
def run_on_hardware(
    circuit: QuantumCircuit, norb, shots, sample_filename, dynamic_decoupling=True
):
    ...
    pass_manager.post_init = PassManager(
        [RemoveIdentityEquivalent(approximation_degree=None)]
    )
    isa_circuit = pass_manager.run(circuit)
